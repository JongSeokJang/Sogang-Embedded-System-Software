...
#include <linux/usb/f_accessory.h>
	...
	#define ACHRO_VENDOR_ID		0x18d1
	#define ACHRO_PRODUCT_ID		0x0001
	#define ACHRO_ADB_PRODUCT_ID	0x0002
#else
...
#define S3C_RNDIS_ADB_PRODUCT_ID       0x6881
...
#if defined(CONFIG_BOARD_ACHRO4210)
	{
		.product_id	= ACHRO_PRODUCT_ID,
		.num_functions	= ARRAY_SIZE(usb_functions_ums),
		.functions	= usb_functions_ums,
	},
	{
		.product_id	= ACHRO_ADB_PRODUCT_ID,
...
#if defined(CONFIG_BOARD_ACHRO4210)
	static char device_serial[MAX_USB_SERIAL_NUM]="BABABEEFBABABEEF";
#else
...
#if defined(CONFIG_BOARD_ACHRO4210)
	.vendor_id		= ACHRO_VENDOR_ID,
	.product_id		= ACHRO_PRODUCT_ID,
	.manufacturer_name	= "Huins",	//"Huins",
	.product_name		= "Achro",	//"ACHRO4210",
#else
