...
#define PIN_SDA			S5PV310_GPC0(0)
#define PIN_SCL			S5PV310_GPC0(3)
...
int __init PixI2c_Init(void)
{
	...
	s5p_gpio_set_conpdn(PIN_SDA, S3C_GPIO_SPECIAL(2));
	s5p_gpio_set_conpdn(PIN_SCL, S3C_GPIO_SPECIAL(2));

	s5p_gpio_set_pudpdn(PIN_SDA, S3C_GPIO_PULL_NONE);
   	s5p_gpio_set_pudpdn(PIN_SCL, S3C_GPIO_PULL_NONE);
