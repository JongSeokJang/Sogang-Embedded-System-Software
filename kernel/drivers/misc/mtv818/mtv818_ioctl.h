#ifndef __MTV818_IOCTL_H__
#define __MTV818_IOCTL_H__
...
//	unsigned char fic_buf[384];
	...
	unsigned int    msc_size[RTV_MAX_NUM_SUB_CHANNEL_USED];  
	unsigned int    msc_subch_id[RTV_MAX_NUM_SUB_CHANNEL_USED]; 
	unsigned char msc_buf[RTV_MAX_NUM_SUB_CHANNEL_USED][16 * 188]; 
} TDMB_CIF_TS_INFO;
...
#define IOCTL_FM_GET_LOCK_STATUS  		_IOR(RAONTV_IOC_MAGIC,54, IOCTL_FM_LOCK_STATUS_INFO)
