...
#ifdef RTV_DAB_ENABLE
		case RTV_TV_MODE_DAB_B3 : case RTV_TV_MODE_DAB_L :   REG54 = 0x08; break;
#endif
		default: return;
	}
...
INT rtvRF_ConfigureAdcClock(E_RTV_TV_MODE_TYPE eTvMode, E_RTV_ADC_CLK_FREQ_TYPE eAdcClkFreqType)
{
...
#ifdef RTV_DAB_ENABLE
		case RTV_TV_MODE_DAB_B3 : case RTV_TV_MODE_DAB_L : REGE9 = (0x54 & 0xF0); break;
#endif
	...
	for(i=0; i<10;i++)
	{
		...
		{
			RTV_DBGMSG1("[rtvRF_ConfigureAdcClock] CLOCK SYNTH 1st step  UnLock.. 0x%x\n",RD15);
		}
...
{	
	...
	for(i=0; i<10;i++)
	{
		...
		{
			RTV_DBGMSG1("[rtvRF_ChangeAdcClock] CLOCK SYNTH 1st step  UnLock.. 0x%x\n", RD15);
		}
	...
	{
		RTV_DBGMSG1("[rtvRF_ChangeAdcClock] DCDC CLOCK SYNTH  UnLock.. 0x%x\n",RD15 );
	}
#endif
