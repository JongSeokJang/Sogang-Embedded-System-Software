...
extern	volatile E_RTV_DAB_TRANSMISSION_MODE g_curDabTrMode;
#endif
...
{	
	...
	switch( eTvMode )
	{
		...
		case RTV_TV_MODE_1SEG:
			...
			RTV_REG_SET(0x62, g_abRtvIntrMaskRegL[RaonTvChipIdx]|MSC0_INTR_BITS|MSC1_INTR_BITS); // FIC, MSC0, MSC1
	  #endif
			break;
	  ...
	  #if defined(RTV_IF_SPI) || defined(RTV_IF_EBI2)
			RTV_REG_MAP_SEL(HOST_PAGE);
		    	RTV_REG_SET(0x62, g_abRtvIntrMaskRegL[RaonTvChipIdx]|MSC0_INTR_BITS|MSC1_INTR_BITS|FIC_E_INT); // FIC, MSC0, MSC1
